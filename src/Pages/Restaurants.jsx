...
const restaurants = [
  {
    ...
    atmosphere:
      "Victorian-Chinese fusion with brass dragons, steam vents, and mechanical tea servers",
  },
  {
    id: 2,
    ...
    atmosphere:
      "Ornate Indian décor with brass steam pipes, mechanical elephants, and automated spice dispensers",
  },
  {
    id: 3,
    ...
    atmosphere:
      "Rustic Italian with exposed brass pipes, mechanical pasta makers, and steam-powered espresso machines",
  },
  {
    id: 4,
    ...
    atmosphere:
      "Colorful Mexican décor with copper steam pipes, mechanical piñatas, and automated tortilla presses",
  },
  {
    id: 5,
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-4xl mx-auto">
            Where global cuisines meet Victorian innovation. Each restaurant
            tells the story of how the Steam Age revolutionized cooking, using
            the same technology that saved civilization from the Crimson Blight.
          </p>
        </div>
        ...
        <div className="mb-12 p-8 bg-gradient-to-r from-orange-100 to-red-100 dark:from-orange-900/20 dark:to-red-900/20 rounded-lg border">
          <div className="text-center">
            ...
            <p className="text-lg text-orange-700 dark:text-orange-300 max-w-4xl mx-auto">
              When steam technology saved us from the plague, it also
              transformed how we cook. Pressure systems, steam injection, and
              clockwork precision brought new flavors and techniques to cuisines
              from around the world. Every meal is a celebration of human
            ...
            >
              <div className="relative">
                ...
                <div className="absolute top-4 left-4">
                  <Badge
                    className={`${getTypeColor(restaurant.type)} text-white`}
                  >
                    {restaurant.type}
                  </Badge>
                </div>
        ...
        <div className="mt-16 p-8 bg-background rounded-lg border">
          <div className="text-center">
            ...
            <p className="text-muted-foreground max-w-4xl mx-auto">
              All our restaurants use the revolutionary cooking technologies
              developed during the fight against the Crimson Blight. From
              pressure cooking that intensifies flavors to steam injection that
              creates perfect textures, every meal is a testament to human
              innovation. Our pneumatic delivery systems ensure your food
              arrives at the perfect temperature, while clockwork precision
