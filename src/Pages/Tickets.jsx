          ...
          <div className="lg:col-span-2">
            ...
            >
              <TabsList className="grid w-full grid-cols-5">
                ...
                <TabsTrigger value="recap">5. Review</TabsTrigger>
              </TabsList>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div className="p-4 bg-orange-50 dark:bg-orange-900/20 rounded-lg">
                      ...
                      <p>
                        <strong>Day:</strong> {getSelectedDay()}
                      </p>
                    </div>
                    ...
                    {/* Attraction Reservations Recap */}
                    {Object.keys(selectedAttractions).some(
                      (key) => selectedAttractions[key]
                    ) && (
                      <div className="border rounded-lg p-4">
                        <h3 className="font-semibold mb-3">
                          Attraction Reservations
                        </h3>
                        {Object.entries(selectedAttractions).map(
                          ([key, selected]) => {
                            if (!selected) return null;
                            const [attractionId, time] = key.split("-");
                            const attraction = attractions.find(
                              (a) => a.id === Number.parseInt(attractionId)
                            );
                            return (
                              <div
                                key={key}
                    ...
                    <div className="border-2 border-orange-200 dark:border-orange-800 rounded-lg p-4 bg-orange-50 dark:bg-orange-900/20">
                      ...
                      <p className="text-sm text-muted-foreground mt-2">
                        Includes all tickets and event reservations. Attraction
                    ...
                    <div className="flex justify-between pt-6">
                      ...
                      <Button
                        size="lg"
                        disabled={getTotalTickets() === 0 || !selectedDate}
                        className="bg-orange-500 hover:bg-orange-600 dark:bg-orange-600 dark:hover:bg-orange-700 px-8"
                      >
